...
import { ProfileJs, SmallProfile } from "../../../styles/profilestyle";
const Profile = () => {
  return (
    <>
      <ProfileJs>
                    ...
                    <div className="three ">
                      ...
                      <div className="four">
                        ...
                        <p>
                          ...
                          assessments to vet talent's <br></br> capabilities, these are
                          role-based extremely stringent tests which filters <br></br> top
                          10% talents
                        </p>
                      </div>
                    </div>
      ...
      <SmallProfile>
        <div className="container">
          ...
          <div className="smProFileBg ">
            <div>
              <h2 className="mt-5">
                We aim to match employee skills with necessary tasks<br></br> in
            ...
            <div>
              <p className="">
                Effective staffing involves understanding company needs, such as
                when it's most important to save money and when it's most
